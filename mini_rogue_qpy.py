...
class MiniRogue:
    ...
    def roll_combat_die(self, sides=6, dies=1, feat_roll=False):
        ...
        if not feat_roll:
            ...
            while len(available_dice) > 0:
                ...
                feat = raw_input("Would you like to attempt a feat? Reroll a die one time by paying 2 HP or 1 XP. \nAvailable dice: {} [y/n]\n".format(available_dice))
    ...
    def store(self):
        ...
        if trade == 8:
            ...
            n = int(raw_input("How many Rations? "))
            self.nxt()
            if check_gold(n*1):
            ...
            n = int(raw_input("How many Health Potions? "))
            self.nxt()
            if check_gold(n*1):
            ...
            n = int(raw_input("How many Big Health Potions? "))
            self.nxt()
            if check_gold(n*3):
            ...
            n = int(raw_input("How many Armor Pieces? "))
            self.nxt()
            if check_gold(n*6):
            ...
            n = int(raw_input("How many Armor pieces would you like to SELL for 3 gold? You have {} armor. ".format(self.armor)))
            self.nxt()
            if n <= self.armor:
    ...
    def combat(self, boss=False):
        while self.monster_life > 0 and self.alive:
            ...
            # Spell usage
            if self.spells:
                cast = raw_input("Would you like to use a spell? \nAvailable spells: {} [y/n]".format(self.spells))
